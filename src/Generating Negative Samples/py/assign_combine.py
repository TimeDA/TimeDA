...
def trans_tree(e, ignore_list=[], instances=None):
    ...
    expr_stmt_elems = [get_expr_stmt(e) if instances is None else (instance[0] for instance in instances)]
    ...
    for item in expr_stmt_elems:
        for expr_stmt_elem in item:
            ...
            expr_stmt_transfrom(expr_stmt_elem, tree_root, expr_stmt_elem_prev_path, new_ignore_list)
