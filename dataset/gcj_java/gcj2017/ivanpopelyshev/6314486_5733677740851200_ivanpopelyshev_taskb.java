package B;
 ...
 /**
  * Created by codejam on 2017-08-11.
  */
 public class TaskB implements Runnable {
     String filename = "B";
 //        String suffix = "-sample";
 //    String suffix = "-small-attempt0";
 ...
 //        for (int i = 0; i < N; i++) {
 //            if (ops[i].opCode == 3 && ops[i].x < 0) {
 //                max = Math.min(max, ops[i].x);
 //            }
 //        }
 //        if (max < INF) {
 //            for (int i = 0; i < N; i++) {
 //                if (ops[i].opCode == 3 && ops[i].x == max) {
 //                    ops[i].opCode = 7;
 //                    break;
 //                }
 //            }
