                     ...
                     if (grid[r][c] == '.') {
                         ...
                         if (horizontal == -1) {
                             if (vertical == -1) {
                                 ...
                                 // vertical must be true (i.e. vertical) i.e. !vertical => vertical
                                 g[vertical+beams].add(vertical);
                             }
                         } else {
                             if (vertical == -1) {
                                 // horizontal must be false (i.e. horizontal) i.e horizontal => !horizontal
                 ...
                 for (int c=0; c<C; c++) {
                     if (grid[r][c] == '-') {
                         ...
                         if (lastBeam == -1) {
                             ...
                             // lastBeam and nextBeam see each other => they must be vertical
                 ...
                 for (int r=0; r<R; r++) {
                     if (grid[r][c] == '-') {
                         ...
                         if (lastBeam == -1) {
                             ...
                             // lastBeam and nextBeam see each other => they must be horizontal
