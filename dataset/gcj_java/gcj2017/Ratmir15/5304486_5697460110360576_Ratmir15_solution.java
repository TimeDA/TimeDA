package codejam.y2017.r1.z2;
 ...
 //                    while (1.1*parts[0]*j<=a[0][i]) {
 //                        j++;
 //                    }
 //                    j--;
 //                    System.out.println(0.9*parts[0]*j);
 //                    if (0.9*parts[0]*j<=a[0][i]) {
 //                        System.out.println(a[0][i]);
 //                    }
 
 //                    double x = 1.0d*a[0][i] / (parts[0]);
 //                    double x = a[0][i] / (0.9 * parts[0]);
 //                    double y = a[0][i] / (1.1 * parts[0]);
 //                    System.out.println(x);
 //                    System.out.println(y);
 //                    System.out.println(Math.floor(y)+" "+Math.ceil(x));
 //                    if (Math.floor(y)==Math.ceil(x)) {
 //                        cnt++;
 //                    }
                 if (n == 2) {
