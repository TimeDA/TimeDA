...
class Config:
    ...
    def source_data_path(self):
        return self.__get('source_data_path')
    def negative_data_path(self):
        return self.__get('negative_data_path')
    def target_data_path(self):
        return self.__get('target_data_path')
    ...
    def skip_read_write(self):
        return self.__get('skip_read_write')

    def final_test(self):
        return self.__get('final_test')

    def final_test(self):
        return self.__get('final_test')
    def stage(self):
        return self.__get('stage')   
    def batch_size(self):
