import static java.lang.Double.parseDouble;
 ...
 public class B {
 	...
 	static void solve() throws Exception {
 		...
 		int den = 1;
 		for (int i = 2; i < n; i++) {
 //			System.err.println("i = " + i + ", den = " + den);
 			int div = i - 1;
 			...
 			den = mul(den, div);
 //			System.err.println(Arrays.toString(sums1));
 //			System.err.println(Arrays.toString(sums2));
 ...
 //			System.err.println(den);
 		...
 		den = mul(den, n - 1);
 //		System.err.println(Arrays.toString(prev) + " " + den);
 		printCase();
